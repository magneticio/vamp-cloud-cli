...
func releaseDTOToModel(release dto.Release) models.Release {
	...
	return models.NewRelease(release.ID, release.State, release.PolicyID, release.SourceVersionID, release.TargetVersionID, release.CurrentStep, release.TargetHealth)
}
