...
func (o *PostClustersParams) WithCluster(cluster *models.ClusterInput) *PostClustersParams {
	o.SetCluster(cluster)
	return o
}

// SetCluster adds the cluster to the post clusters params
func (o *PostClustersParams) SetCluster(cluster *models.ClusterInput) {
	o.Cluster = cluster
}
